<template>
  <div class="mcp-manager">
      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            ...
            <el-button v-if="store.hasButtonPermission('mcp:create') || store.isAdmin" @click="openMarketDialog">
              <i class="fas fa-store"></i> MCP 市场
            </el-button>
    ...
    <!-- MCP 市场对话框 -->
    <el-dialog v-model="marketDialogVisible" title="MCP 市场 — 热门服务快速引入" width="880px" destroy-on-close>
      <el-input v-model="marketSearch" placeholder="搜索名称 / 描述 / 分类" clearable style="margin-bottom: 12px" />
      <el-table :data="filteredMarketItems" stripe size="small" v-loading="marketLoading" style="width: 100%" max-height="460">
        ...
        <el-table-column label="操作" width="80" align="center">
          <template #default="{ row }">
            <el-button size="small" type="primary" text @click="handleMarketImport(row)">引入</el-button>
          </template>
        </el-table-column>
      </el-table>
