...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'login-logs', name: 'LoginLogs', component: () => import('../views/LoginLogs.vue'), meta: { menu: 'login_logs', title: '登录日志' } },
      { path: 'operation-logs', name: 'OperationLogs', component: () => import('../views/OperationLogs.vue'), meta: { menu: 'operation_logs', title: '操作日志' } },
