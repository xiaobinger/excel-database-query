...
### AI对话排队消息支持重新编辑 + 插话立即停止并采纳 (v2.6.1)
...
| 日期 | 版本 | 内容 |
|------|------|------|
| 2026-09-03 | v2.6.1 | AI对话排队消息支持重新编辑（行内编辑模式+Ctrl+Enter保存/Esc取消）；插话三种模式（🛑立即停止并采纳/⚡插话发送/🕐排队发送）；后端interrupt接口新增mode参数，stop_and_adopt模式立即终止流并保存新指令等待重新执行 |
